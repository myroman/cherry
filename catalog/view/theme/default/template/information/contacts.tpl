  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="article-wrapper">
        ...
        <!-- <button type="button" class="btn btn-default btn-med btn-buy_green">Задать вопрос</button> -->
        ...
        <p>
          ...
          <a href="mailto:info@legionfirst.ru">info@legionfirst.ru
          </a></p>
        <a href="mailto:info@legionfirst.ru">

        </a>
        <div class="panel panel-default"><a href="mailto:info@legionfirst.ru">
          </a>
          <div class="panel-heading"><a href="mailto:info@legionfirst.ru">
            </a>
            <h4 class="panel-title"><a href="mailto:info@legionfirst.ru">
              </a><a href="#collapse-checkout-option1" data-toggle="collapse" data-parent="#accordion"
