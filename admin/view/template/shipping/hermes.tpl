  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="submit" form="form-hermes-parcels" data-toggle="tooltip"
          title="<?php echo $button_refresh_handout; ?>" class="btn btn-primary"><i class="fa fa-refresh"></i></button>
